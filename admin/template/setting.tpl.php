...
<table cellspacing="0" class="tb">
    <tr>
        <td class="tl">赛邮云Appid:</td>
        <td><input name="config[cloud_uid]" type="text" id="cloud_uid" value="<?php echo $cloud_uid;?>" size="30"/>&nbsp;&nbsp;&nbsp;&nbsp;<a href="https://www.mysubmail.com/chs/store" target="_blank" class="t">[没有账号,点此申请帐号]</a></td>
    </tr>
    <tr>
        <td class="tl">赛邮云Appkey</td>
    ...
    <tr>
        <td class="tl">快递追踪</td>
        <td><input type="radio" name="setting[cloud_express]" value="1"  <?php if($cloud_express){ ?>checked <?php } ?>/> 开启&nbsp;&nbsp;&nbsp;&nbsp;
